...
Experiment No. 6 - Employee Management System using Python and PostgreSQL: 
Develop a Python-based system to manage employee data using a PostgreSQL relational database. The system must support the creation, retrieval, and management of employees, departments, and roles, and demonstrate the implementation of basic CRUD (Create, Read, Update, Delete) operations.
...
Experiment No. 8 - Design a Data Lifecycle Pipeline for a Retail Scenario using PostgreSQL and Python
Simulate a data lifecycle pipeline (Capture → Store → Process → Analyze → Visualize) for retail transactions using PostgreSQL as the database and Python for ETL, analysis, and visualization.
